...
//  PackdApp
//
//  Created by Cristiano Calicchia on 24/11/24.
//  Copyright © 2024 deruloop. All rights reserved.
//
import SwiftUI

//MARK: https://medium.com/@jaredcassoutt/swiftui-tutorials-designing-a-dynamic-confetti-effect-aa531c5adfb1
...
public struct ConfettiContainerView: View {
	var count: Int = 50
...
public struct DisplayConfettiModifier: ViewModifier {
